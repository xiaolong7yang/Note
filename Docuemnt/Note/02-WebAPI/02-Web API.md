...
API（Application Programming Interface,应用程序编程接口）是一些预先定义的函数，目的是提供应用程序与开发人员基于某软件或硬件得以访问的能力，而又无需访问源码，或理解内部工作机制的细节。
...
1. a标签的点击事件可以通过返回false组织跳转，或者根据用户对话框选择跳转指定的链接
...
- innerHTML和innerText和textContent
